    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Registro B. Ejemplo 1: Visualización en LEDs\n\nEjemplo de prueba del registro B. El programa carga  \ndos valores en el registro B a través de la instrucción  \nADD: 0xC0 y 0x03. Al ejecutarlo paso a paso vemos en los LEDs  \nlos dos valores y finalmente el programa termina  \nLa salida del registro B está conectada a los LEDs",
            "readonly": true
          },
          "position": {
            "x": 264,

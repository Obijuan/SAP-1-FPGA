  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "53f44f77-4839-4d05-af32-d63782173dd0",
          "type": "basic.output",
          "data": {
            "name": "T",
            "range": "[5:0]",
        ...
        {
          "id": "d1fe0c02-5bce-4494-9067-c8cc3b4889a9",
          "type": "basic.constant",
          "data": {
            "name": "Periodo",
            "value": "200",
        ...
        {
          "id": "a5c5ecef-2d0e-4b98-bfbc-07c6ac1eab6a",
        ...
        {
          "id": "69de270d-ce4f-43b1-b61d-11cceb258cd0",
        ...
        {
          "id": "af753423-b705-4e29-9bad-755a6f7ef153",
          "type": "basic.info",
          "data": {
            "info": "# Secuenciador. Ejemplo 3: Ejecución en continuo\n\nAl apretar el pulsador arranca el secuenciador en **modo continuo**  \ny genera las señales de estado para ejecutar las instrucciones  \nunas detrás de otras. Cuando acaba un **ciclo de instrucción**  \ncomienza automáticamente otro",
            "readonly": true
          },
          "position": {
            "x": 232,
        ...
        {
          "id": "07526fa5-e14b-4a0f-9244-2d4c32aaafd8",
          "type": "basic.info",
          "data": {
            "info": "Tic de  \narranque",
            "readonly": true
        ...
        {
          "id": "3f39fec1-d1f7-4dd7-abca-b254f40394f5",
          "type": "basic.info",
          "data": {
            "info": "Pulsador para arrancar con el  \nciclo de instrucción",
            "readonly": true
          },
          "position": {
            "x": 248,
        ...
        {
          "id": "c21c6d5e-f780-474a-ace7-92244896ce39",
          "type": "basic.info",
          "data": {
            "info": "**Bloque**  \n**Secuenciador**",
            "readonly": true
        ...
        {
          "id": "57b19b98-4244-4734-96fb-3109c4757f3e",
          "type": "basic.info",
          "data": {
            "info": "Señal de reloj",
            "readonly": true
        ...
        {
          "id": "822d4e6f-2075-4e29-a00c-30772c6449f9",
        ...
        {
          "id": "6d40472f-04ee-4e0f-b9ef-bf382a55c257",
          "type": "basic.info",
          "data": {
            "info": "Indicar el estado activo  \nen los LEDs",
            "readonly": true
          },
          "position": {
            "x": 1216,
        ...
        {
          "id": "baa4285f-6f6f-4b61-b17c-837e47d42a90",
          "type": "basic.info",
          "data": {
            "info": "Mostrar el estado del ciclo de instrucción:  \n0: No se está ejecutando instrucción  \n1: Ejecutando instrucción",
            "readonly": true
          },
          "position": {
            "x": 1080,
        ...
        {
          "id": "fb99359b-fe1a-4f8a-9e5e-326a7825f69e",
        ...
        {
          "id": "7ac05b15-e185-422d-ba63-b869a6b8e8e3",
          "type": "basic.info",
          "data": {
            "info": "Comenzar un ciclo  \nde instrucción  \nnuevo",
            "readonly": true
          },
          "position": {
            "x": 712,
        ...
        {
          "id": "a3159d55-446a-4f4c-acd5-230f02c82365",
          "type": "basic.info",
          "data": {
            "info": "Ciclo de instrucción  \nacabado. ¡Que comience  \nel siguiente!",
            "readonly": true
          },
          "position": {
            "x": 648,
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "a5c5ecef-2d0e-4b98-bfbc-07c6ac1eab6a",
            "port": "21bc142d-a93a-430d-b37a-326435def9f9"
          }
        },
        {
          "source": {
            "block": "69de270d-ce4f-43b1-b61d-11cceb258cd0",
        ...
        {
          "source": {
            "block": "d1fe0c02-5bce-4494-9067-c8cc3b4889a9",
            "port": "constant-out"
          },
          "target": {
            "block": "69de270d-ce4f-43b1-b61d-11cceb258cd0",
        ...
        },
        {
          ...
          "target": {
            "block": "822d4e6f-2075-4e29-a00c-30772c6449f9",
        ...
        },
        {
          ...
          "target": {
            "block": "53f44f77-4839-4d05-af32-d63782173dd0",
            "port": "in"
          },
          "size": 6
        },
        {
          "source": {
            "block": "69de270d-ce4f-43b1-b61d-11cceb258cd0",
            "port": "9e72a3f7-5301-4d85-b29d-591d00d16f16"
          },
          "target": {
        ...
        {
          "source": {
            "block": "fb99359b-fe1a-4f8a-9e5e-326a7825f69e",

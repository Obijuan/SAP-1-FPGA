    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Registro de Instrucción. Ejemplo 1: Visualización en LEDs\n\nEjemplo de prueba del registro de instrucción. La instrucción  \nalmacenada en el registro IR se muestra por los LEDs. Con cada  \npulsación del botón se carga la siguiente instrucción  \nAl cargar la instruccción HALT de la dirección 5 se para el  \nprocesador y se enciende el led externo",
            "readonly": true
          },
          "position": {
            "x": 1224,

  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "ed1ba5ed-5c83-4a87-aa56-7423fa39070f",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "c3cce27e-5119-4ed3-8ba5-077d9e5775fc",
          "type": "basic.output",
          "data": {
            "name": "CP",
            "pins": [
        ...
        {
          "id": "688ffb1e-f22f-4f46-867d-329ffbafed03",
          "type": "basic.output",
          "data": {
            "name": "EP",
            "pins": [
        ...
        {
          "id": "46a8fe87-3465-4c8b-8d25-88421325205d",
          "type": "basic.output",
          "data": {
            "name": "LM#",
            "pins": [
        ...
        {
          "id": "d7440f2d-b649-4fd6-aea9-e83bca7be6ab",
          "type": "basic.output",
          "data": {
            "name": "CE#",
            "pins": [
        ...
        {
          "id": "f941c57b-ce6f-40ae-b7a8-806a5466a8c8",
          "type": "basic.output",
          "data": {
            "name": "LI#",
            "pins": [
        ...
        {
          "id": "99088463-af3f-4819-9131-e23600c3e848",
          "type": "basic.output",
          "data": {
            "name": "EI#",
            "pins": [
        ...
        {
          "id": "d88fa0e8-c004-4e0b-95c1-26d6a94e8bb4",
          "type": "basic.output",
          "data": {
            "name": "LA#",
            "pins": [
        ...
        {
          "id": "87e214f9-51d3-423c-8bbd-83480c291dcd",
          "type": "basic.output",
          "data": {
            "name": "EA",
            "pins": [
        ...
        {
          "id": "94292e10-05c7-49a1-9c63-d65130f15667",
          "type": "basic.output",
          "data": {
            "name": "SU",
            "pins": [
        ...
        {
          "id": "6d9bfef0-af9b-42d6-8977-52190a82282a",
          "type": "basic.output",
          "data": {
            "name": "EU",
            "pins": [
        ...
        {
          "id": "887229b1-0987-4963-940a-da308bd809e6",
          "type": "basic.output",
          "data": {
            "name": "LB#",
            "pins": [
        ...
        {
          "id": "98c90dfa-65f2-43fb-a70a-f5ccd00a3af1",
          "type": "basic.output",
          "data": {
            "name": "LO#",
            "pins": [
        ...
        {
          "id": "e52a2077-c7c9-4d3f-a0be-49caab95ff7b",
          "type": "basic.constant",
          "data": {
            "name": "INICIAL",
            "value": "'hA",
        ...
        {
          "id": "3096f0cc-d586-46db-87a8-51df22726396",
          "type": "basic.info",
          "data": {
            "info": "# Unidad de control. Ejemplo 1: Probando HLT\n\nPrueba de funcionamiento de la unidad de control. Se prueba la instrucción HALT  \nAl apretarse el pulsador, se introduce la instruccion HALT en la unidad de control  \ny se desactiva. Se puede comprobar que el LED se enciende\n\nSi se prueba con otra instrucción que no sea HLT, el led no se enciende. Además,  \nse podrán ver las microórdenes con el analizador lógico\n",
            "readonly": true
          },
          "position": {
            "x": 496,
        ...
        {
          "id": "802a9a3f-e8fe-486f-96ea-9f1617c4883d",
          "type": "basic.info",
          "data": {
            "info": "Instrucción: HLT",
            "readonly": true
          },
          "position": {
            "x": -496,
        ...
        {
          "id": "4d8ebeb0-2520-4e9a-af99-e4c7fd7a21fd",
        ...
        {
          "id": "c4f2e295-0ac6-40d8-8bef-63556bac73d8",
        ...
        {
          "id": "b3000951-1839-49de-86c7-ad2871113dbf",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "9414d60e-f6c3-497e-bf60-b8a444c662e2",
          "type": "basic.info",
          "data": {
            "info": "Capturar la instrucción  \nal apretar el pulsador",
            "readonly": true
          },
          "position": {
            "x": -240,
        ...
        {
          "id": "d806a1b1-079a-4e50-9397-3814caa350f1",
        ...
        {
          "id": "463e3a40-657b-4474-9efc-77f2e8867ee2",
          "type": "basic.info",
          "data": {
            "info": "Instrucción inicial  \ndesconocida",
            "readonly": true
          },
          "position": {
            "x": -208,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "4d8ebeb0-2520-4e9a-af99-e4c7fd7a21fd",
            "port": "9d841934-73aa-4e96-b6a8-37b9625f7fa2"
          },
          "target": {
            "block": "c3cce27e-5119-4ed3-8ba5-077d9e5775fc",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "688ffb1e-f22f-4f46-867d-329ffbafed03",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "46a8fe87-3465-4c8b-8d25-88421325205d",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "d7440f2d-b649-4fd6-aea9-e83bca7be6ab",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "99088463-af3f-4819-9131-e23600c3e848",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "d88fa0e8-c004-4e0b-95c1-26d6a94e8bb4",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "94292e10-05c7-49a1-9c63-d65130f15667",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "6d9bfef0-af9b-42d6-8977-52190a82282a",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "887229b1-0987-4963-940a-da308bd809e6",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "98c90dfa-65f2-43fb-a70a-f5ccd00a3af1",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "87e214f9-51d3-423c-8bbd-83480c291dcd",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "f941c57b-ce6f-40ae-b7a8-806a5466a8c8",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "c4f2e295-0ac6-40d8-8bef-63556bac73d8",
        ...
        },
        {
          ...
          "target": {
            "block": "ed1ba5ed-5c83-4a87-aa56-7423fa39070f",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "d806a1b1-079a-4e50-9397-3814caa350f1",
        ...
        {
          "source": {
            "block": "e52a2077-c7c9-4d3f-a0be-49caab95ff7b",
            "port": "constant-out"
          },
          "target": {
            "block": "d806a1b1-079a-4e50-9397-3814caa350f1",

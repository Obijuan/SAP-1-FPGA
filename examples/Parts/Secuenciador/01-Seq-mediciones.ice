  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "da6cd306-189b-4ea7-8f08-a5b171f3b14d",
          "type": "basic.output",
          "data": {
            "name": "Canal-0",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Secuenciador. Ejemplo 1: Mediciones\n\nAl apretar el pulsador se genera un **ciclo  \ncompleto de instrucción**. Las señales se  \ncapturan con el analizador lógico conectado  \na los pines **D0-D6** de la placa **Alhambra II**  \nSe utiliza un periodo de reloj de 2 ms",
            "readonly": true
          },
          "position": {
            "x": 400,
        ...
        {
          "id": "bae11bb0-30de-43ce-96b6-381f7ddbdc89",
          "type": "basic.info",
          "data": {
            "info": "Señales de estado  \nT1-T6. Conectadas  \na los canales del analizador",
            "readonly": true
          },
          "position": {
            "x": 1280,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "da6cd306-189b-4ea7-8f08-a5b171f3b14d",
            "port": "in"
          }
        },
        {

    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Secuenciador. Ejemplo 2: LEDs\n\nAl apretar el pulsador se genera un **ciclo  \ncompleto de instrucción**. Las señales de  \nestado, el reloj y busy se muestran en los LEDs  \nEl LED de busy está encendido mientras dura un  \nel ciclo de instrucción, luego se apaga",
            "readonly": true
          },
          "position": {
            "x": 344,

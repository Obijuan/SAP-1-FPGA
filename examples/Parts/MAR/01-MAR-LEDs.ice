    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# Registro MAR. Ejemplo 1: Visualización en LEDs\n\nEjemplo de prueba del registro MAR. Su contenido se muestra en los  \nLEDs. En el estado T1 el PC se vuelca en el BUS W, y en T2  \nla dirección se captura en MAR y se muestra en los LEDs  \n\nComo se está utilizando el código de operación de la instrucción OUT  \npara hacer las pruebas, el registro MAR contiene lo que haya en el  \nPC. En los LEDs veremos lo mismo que en el ejemplo 1 del PC:  \nLos valores del 0 al 15",
            "readonly": true
          },
          "position": {
            "x": 888,
